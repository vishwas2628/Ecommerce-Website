  ...
  return (
    <div className='my-10'>
        <div className='text-center text-3xl py-8'>
            ...
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet nisi a tempora recusandae. Nostrum beatae ullam odit in, vero fugiat hic. Harum ipsa odit inventore.
            </p>
        </div>
